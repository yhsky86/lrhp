$(function(){
    ...
    <section class="provisionWrap">
            ...
            <div class="agree-form-box form-cont">
                <div class="row type2">
                    ...
                    <div class="input-cont">
                        <ul class="radio-area">
                            <li><div class="radio-icon-box">
                                <input type="radio" id="" name="" checked="">
                                <label for="">동의함</label>
                            </div></li>
                            <li><div class="radio-icon-box">
                                <input type="radio" id="" name="" checked="">
                                <label for="">동의하지 않음</label>
                            </div></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row type2">
                    <span class="input-tit">제 2운전자</span>
                    <div class="input-cont">
                        <ul class="radio-area">
                            <li><div class="radio-icon-box">
                                <input type="radio" id="" name="" checked="">
                ...
                <div class="row type2">
                    ...
                    <div class="input-cont">
                        <ul class="radio-area">
                            <li><div class="radio-icon-box">
                                <input type="radio" id="" name="" checked="">
                                <label for="radioTest">동의함</label>
                            </div></li>
                            <li><div class="radio-icon-box">
                                <input type="radio" id="" name="" checked="">
                                <label for="radioTest">동의하지 않음</label>
                            </div></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="agree-form section-form">
            ...
            <div class="agree-form-box form-cont">
                <h4>본인은 귀사가 위와 같이 본인의 고유식별정보를 수집 ∙ 이용하는 것에 동의합니다.</h4>
                <div class="row type2">
                    <span class="input-tit">임차인</span>
                    <div class="input-cont">
                        <ul class="radio-area">
                ...
                <div class="row type2">
                    ...
                    <div class="input-cont">
                        <div class="box-between">
                            <div class="inputT type-left">						
                                <input type="text" id="" placeholder="">
                                <span class="left-txt">년</span>
                            </div>
                            <div class="inputT type-left">						
                                <input type="text" id="" placeholder="">
                                <span class="left-txt">월</span>
                            </div>
                            <div class="inputT type-left">						
                                <input type="text" id="" placeholder="">
                                <span class="left-txt">일</span>
                            </div>
                            <div class="inputT type-left">						
                                <input type="text" id="" placeholder="">
                                <span class="left-txt">성명</span>
                            </div>
                        </div>
                    </div>
                </div>
