$(function(){
	...
	<header class="header eng-header">
		...
		<nav class="header-nav header-nav-line eng-header-nav">
			<div class="inner">
				<div class="nav-wrap">
					<h1><a href="#none"><img src="/lrhp/pc/images/common/eng-logo-header.png" alt="LOTTE rental"/></a></h1>
					<ul>
						<li>
			...
			<div class="draw-toggle-wrap draw-toggle-wrap-s">
				...
				<div class="layer-gnb-bn layer-gnb-bn-e">
					<div class="gnb-banner">
						<a href="#"><img src="/lrhp/pc/images/@temp-eng-login-bn02.png" alt="Members Benefits"></a>
					</div>
				</div>
			</div>
			<!--- 드롭다운 메뉴 추가-->
